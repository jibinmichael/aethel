...
const HomePage = ({ onStartThinking, onSelectBoard }) => {
  ...
  const handleNewBoard = async () => {
    const result = await boardStore.createBoard('Untitled Board')
    if (result.success) {
    ...
    >
      <Box sx={{ width: 580, maxHeight: '80vh', overflow: 'auto' }}>
        ...
        <Box sx={{ 
          ...
          >
            "If you want to build a ship, don't drum up people to collect wood... Instead, teach them to long for the endless immensity of the sea." — Antoine de Saint-Exupéry
          </Typography>
        </Box>
       </Box>
      </Box>
